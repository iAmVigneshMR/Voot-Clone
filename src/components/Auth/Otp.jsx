...
const Otp = ({ history }) => {
    ...
    let handleSubmit = async e => {
      ...
      try {
        ...
        const captchaVerifier = new firebase.auth.RecaptchaVerifier("recaptcha-container");   //for phone verification
        let confirmResult = await firebase.auth().signInWithPhoneNumber(phone , captchaVerifier);
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label htmlFor="phone">Enter valid Phone Number</label>
              </div>
